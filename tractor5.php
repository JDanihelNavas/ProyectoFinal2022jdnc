...
<body>
    <div class="container">
        ...
        <img src="images/oruga2.jpg">
        <h3>TRACTOR ORUGA</h3>
        <P>Un tractor oruga es un dispositivo de tracción utilizado principalmente en vehículos pesados, como carros de combate y tractores, u otro tipo de vehículos.</P>
        <br>
