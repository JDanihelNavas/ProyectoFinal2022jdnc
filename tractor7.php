...
<head>
    ...
    <title>Tractor de Doble Traccion</title>
</head>
<body>
...
<tr>
  ...
  <td colspan="4">
    ...
    <div class="container">
       ...
       <center> <img src="images/doble.jpg"></center>
        <h3 align="center" style="color:white;">TRACTOR DOBLE TRACCION</h3>
        <P align="center" style="color:white;">Son unidades diseñadas para obtener una alta eficiencia tractiva. La misma es aproximadamente el 75% de la potencia que posee en la toma de potencia.</P>
        <br>
