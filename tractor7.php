...
<body>
    <div class="container">
        ...
        <h3>TRACTOR DOBLE TRACCION</h3>
        <P>Son unidades diseñadas para obtener una alta eficiencia tractiva. La misma es aproximadamente el 75% de la potencia que posee en la toma de potencia.</P>
        <br>
