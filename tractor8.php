...
<body>
    <div class="container">
        ...
        <h3>TRACTOR RIGIDO</h3>
        <P>presentan ruedas de diferente diámetro, siendo más grandes las motrices que las directrices. Estos tractores son muy polivalentes y actualmente son los más vendidos ya que se adaptan a todas las necesidades agrícolas.</P>
        <br>
